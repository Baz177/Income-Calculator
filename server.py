...
from income import gmi_w2, time as calculate_time
...
def year_to_date():
    ...
    try:
        ...
        print("Parsed data:", year, month, day, ytd_income, end_day, data.keys())
        ...
        time = calculate_time(start_date, end_day)
        ...
        result = {
            ...
            'gmi': gmi,
            'message': "Customer's Gross Monthly Income (GMI) based on YTD income"
        }
...
def w2_details():
    ...
    try:
        ...
        result = {
            ...
            'ytd_income': 0,
            'gmi': 0,
            'message': f"Calculated based on {income_type} rate"
        }
...
def three_month_income():
    ...
    result = {
        'gmi': gmi,
        'message': "Calculated based on Bank Deposits"
    }
    print("Rendering gmi.html with result:", result)
